...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(asset('images/logo_polije.png')); ?>">
    ...
    <div class="header">
        ...
        <div class="header-left">
            <div class="logo-container">
                <img src="<?php echo e(asset('images/polije.png')); ?>" alt="Logo Polije">
            </div>
...
<div class="nav" id="mainNav">
    <a href="<?php echo e(route('beranda')); ?>">PROFIL BISNIS</a>
    <div class="nav-item">
        <div class="nav-link" onclick="toggleDropdown(this)">
            PROGRAM STUDI <span class="dropdown-arrow">▼</span>
        </div>
        <div class="dropdown-menu">
            <?php $__currentLoopData = $allProgramStudis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prodi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                
                <a class="dropdown-item" href="<?php echo e(route('prodi.detail', $prodi->slug)); ?>">
    ...
    <div class="nav-item">
        ...
        <div class="dropdown-menu">
            <?php $__currentLoopData = $kategoriAkademik; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="dropdown-item" href="<?php echo e(route('akademik', ['kategori' => Str::slug($item->kategori)])); ?>">
    ...
    <div class="nav-item">
        ...
        <div class="dropdown-menu">
            <?php $__currentLoopData = $kategoriFasilitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a class="dropdown-item" href="<?php echo e(route('fasilitas', ['kategori' => Str::slug($item->kategori)])); ?>">
                    <?php echo e($item->kategori); ?>
            ...
            <a class="dropdown-item" href="<?php echo e(route('fasilitas')); ?>">
    ...
    <div class="nav-item">
        ...
        <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="<?php echo e(route('dosen')); ?>">Dosen</a>
            <a class="dropdown-item" href="<?php echo e(route('staf')); ?>">Staf Teknisi</a>
    ...
    <!-- <div class="nav-item">
        ...
        <div class="dropdown-menu">
            <a class="dropdown-item" href="<?php echo e(route('artikel')); ?>">Artikel & Berita</a>
            <a class="dropdown-item" href="<?php echo e(route('prestasi')); ?>">Prestasi</a>
        </div>
    </div> -->

    <a href="<?php echo e(Request::is('/') ? '#kontak' : url('/#kontak')); ?>">KONTAK</a>
</div>
        ...
        <div class="partnership">
            ...
            <div class="partner-grid">
                <div class="partner-logo">
                    <img src="<?php echo e(asset('images/1.png')); ?>" alt="OJK - Otoritas Jasa Keuangan">
                </div>
                <div class="partner-logo">
                    <img src="<?php echo e(asset('images/2.png')); ?>" alt="Sembilan Bintang Lestari">
                </div>
                <div class="partner-logo">
                    <img src="<?php echo e(asset('images/3.png')); ?>" alt="Tugu Monument">
                </div>
                <div class="partner-logo">
                    <img src="<?php echo e(asset('images/4.png')); ?>" alt="Kementerian">
                </div>
                <div class="partner-logo">
                    <img src="<?php echo e(asset('images/5.png')); ?>" alt="IAI Wilayah Jawa Timur">
                </div>
            </div>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\USER\Documents\laragon\www\jurusan_bisnis\resources\views/layouts/app.blade.php ENDPATH**/ ?>