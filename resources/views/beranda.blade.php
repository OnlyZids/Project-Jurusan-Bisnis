...
<style>
    ...
    /* ===== HERO SECTION ===== */
    .hero-section {
        background-image: url('{{ asset('images/bisnis.jpg') }}');
...
<section class="hero-section" data-aos="fade-up">
    ...
    {{-- ALERT SUKSES KETIKA SUBMIT KIRIM PESAN --}}
    @if(session('success'))
    ...
    <div class="row g-5 align-items-center">
        <div class="col-lg-7">
            ...
            <div class="col-lg-5" data-aos="fade-left">
                <img src="{{ asset('images/j bisnis.jpg') }}" 
...
<div class="container my-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('artikel') }}" class="btn btn-outline-primary btn-sm rounded-pill px-4">
                ...
                <div class="card h-100 shadow-sm border-0 hover-card">
                    ...
                    <div class="card-body d-flex flex-column">
                        <small class="text-muted mb-2">
                            <i class="far fa-calendar-alt me-1"></i> {{ $item->tanggal_publish->format('d M Y') }}
                        </small>
                        ...
                        <a href="{{ route('artikel.detail', $item->slug) }}" class="btn btn-sm btn-outline-primary">Baca Selengkapnya</a>
                    </div>
                </div>
            </div>
            @endforeach
    ...
    <div class="py-5" style="background-color: #f8f9fa;"> {{-- Background abu muda biar beda --}}
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold" style="color: #000033; border-left: 5px solid #fbbf24; padding-left: 15px;">
                    PRESTASI KAMI
                </h2>
                <a href="{{ route('prestasi') }}" class="btn btn-outline-primary btn-sm rounded-pill px-4">
                    Lihat Semua <i class="fas fa-arrow-right ms-2"></i>
                </a>
            </div>

            <div class="row g-4">
                @foreach ($latestPrestasis as $item)
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="{{ $loop->iteration * 100 }}">
                    <div class="card h-100 shadow border-0">
                        <div class="position-relative" style="height: 220px;">
                            {{-- Badge Tingkat --}}
                            <div class="position-absolute top-0 end-0 m-3 z-1">
                                <span class="badge bg-warning text-dark shadow-sm">{{ $item->tingkat }}</span>
                            </div>
                        ...
                        <div class="card-body">
                            <h5 class="card-title fw-bold" style="color: #000033;">
                                <a href="{{ route('prestasi.detail', $item->slug) }}" class="text-decoration-none text-reset stretched-link">
                                    {{ Str::limit($item->judul, 50) }}
                                </a>
                            </h5>
                            <p class="card-text mb-1 text-primary fw-bold">
                                <i class="fas fa-trophy me-2"></i> {{ $item->pemenang }}
                            </p>
